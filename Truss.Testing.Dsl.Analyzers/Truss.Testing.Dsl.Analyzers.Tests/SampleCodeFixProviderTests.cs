...
using Xunit;
using Verifier =
    Microsoft.CodeAnalysis.CSharp.Testing.XUnit.CodeFixVerifier<Truss.Testing.Dsl.Analyzers.SampleSyntaxAnalyzer,
        Truss.Testing.Dsl.Analyzers.SampleCodeFixProvider>;

namespace Truss.Testing.Dsl.Analyzers.Tests;
