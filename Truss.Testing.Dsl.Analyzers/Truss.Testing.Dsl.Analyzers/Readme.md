...
### Truss.Testing.Dsl.Analyzers.Sample
A project that references the sample analyzers. Note the parameters of `ProjectReference` in [Truss.Testing.Dsl.Analyzers.Sample.csproj](../Truss.Testing.Dsl.Analyzers.Sample/Truss.Testing.Dsl.Analyzers.Sample.csproj), they make sure that the project is referenced as a set of analyzers. 

### Truss.Testing.Dsl.Analyzers.Tests
